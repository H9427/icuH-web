<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="name" label="插画名称" width="100" ></el-table-column>
      <el-table-column prop="tag" label="插画标签" width="100"></el-table-column>
      <el-table-column prop="description" label="插画描述" ></el-table-column>
      ...
      <el-table-column prop="loves" label="爱心数" width="80"></el-table-column>
